...
fct_transaction_dt = DeltaTable.forName(spark, f"wwi_fct.{fct_table_name}")

# Append new records.
stg_transaction_df.write.format("delta").mode("append").saveAsTable(f"wwi_fct.{fct_table_name}")
