...
stg_transaction_df = get_wwi_db_dataframe(control_metadata["datasource_name"], sp_params)
...
# Insert overwrite.
stg_transaction_df.write.format("delta").mode("overwrite").saveAsTable(f"wwi_stg.{stg_table_name}")
